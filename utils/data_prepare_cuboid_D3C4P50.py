...
dataset_path = '/data/cuboid_D3C4P50/cuboid_D3C4P50.1mpoints_annotated'
anno_paths = [line.rstrip() for line in open(join(BASE_DIR, 'meta/anno_paths.txt'))]    # where is the anno_paths of semantic3d
